...
<div class="formulario">
    ...
    <form method="POST" action="{{ route('planta.store')}}">
        ...
        <div class="mb-3">
            ...
            <select name="nombre_tipo" class="form-control" value="{{$planta->nombre_tipo}}" id="nombre_tipo">
        ...
        <div class="mb-3">
            ...
            <select name="estado" class="form-control" id="estado_planta" value="{{$planta->estado}}">
